...
export function EnhancedPathSuggestions({ pathOptions }: EnhancedPathSuggestionsProps) {
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <h3 className="text-lg text-gray-800">{path.title}</h3>
            ...
            {isExpanded && (
              <div className="p-5">
                ...
                <div className="mt-5 flex gap-3">
                  <button className="flex-1 px-4 py-2.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors shadow-sm">
                    Select This Plan
                  </button>
